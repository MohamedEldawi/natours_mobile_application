...
class _ApiService implements ApiService {
  _ApiService(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??=
        'http://natours-env.eba-5u5qsine.us-east-1.elasticbeanstalk.com/api/v1/';
  }
  ...
  @override
  Future<ToursResponse> getAllTours() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ToursResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ToursResponse _value;
    try {
      _value = ToursResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<PaymentIntentResponse> getClientSecret(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<PaymentIntentResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
